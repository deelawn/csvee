...
func TestReader_Read(t *testing.T) {
	...
	*intPtr = 9
	...
	var testCases = []struct {
		...
		{
			name:            "non string value missing",
			inData:          `29.4,,,"hello ""you""",9,"8,4,3,5","this,is,not,a,test",1613235342,1991-04-05T11:11:11Z`,
			inColumnNames:   []string{"F", "I", "B", "S", "IP", "IA", "SA", "Tu", "T"},
			inColumnFormats: map[string]string{"Tu": TimeFormatUnix},
			expData: readTo{
				F:  29.4,
		...
		{
			name:            "no value for pointer field",
			inData:          `29.4,3,true,"hello ""you""",,"8,4,3,5","this,is,not,a,test",1613235342,1991-04-05T11:11:11Z`,
			inColumnNames:   []string{"F", "I", "B", "S", "IP", "IA", "SA", "Tu", "T"},
			inColumnFormats: map[string]string{"Tu": TimeFormatUnix},
			expData: readTo{
				F:  29.4,
